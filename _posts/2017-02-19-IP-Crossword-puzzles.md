...
**EDIT:** There is a [free and open-source crossword compiler]() that a kind reader alerted me to after my initial post.  I haven't tested it personally yet, but it appears high quality, with a nice user interface, and is written in C.  It also appears to use constraint satisfaction, as I discuss below.   (If you know of any others, please [contact me](http://twitter.com/thestevemo).)  I think there is still value added in having multiple open source options, and I still think the IP formulation described below deserves some attention, as I will attempt to justify.
